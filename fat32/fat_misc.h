...
// Big Endian
	...
	#define SET_32BIT_WORD(buffer, location, value)	{ buffer[location+0] = (BYTE)((value)&0xFF); buffer[location+1] = (BYTE)((value>>8)&0xFF); buffer[location+2] = (BYTE)((value>>16)&0xFF); buffer[location+3] = (BYTE)((value>>24)&0xFF); }

	#define SET_16BIT_WORD(buffer, location, value)	{ buffer[location+0] = (BYTE)((value)&0xFF); buffer[location+1] = (BYTE)((value>>8)&0xFF); }
#endif
